...
import type { Employee, AttendanceLog as AttendanceLogType, PayrollResult, PendingActionType } from "../types";
...
export default function HRTab({ employees, attendanceLogs, calculatePayroll, onOpenAuth }: HRTabProps) {
  return (
    <motion.div
      key="hr"
