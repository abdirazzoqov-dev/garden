...
import { ShoppingCart, BarChart3, Users, ClipboardList, ChefHat, Tag, FileText, UserCircle, Settings, Code2 } from "lucide-react";
...
const TABS: { id: ActiveTab; label: string; short: string; icon: React.ReactNode; accent?: boolean }[] = [
  ...
  { id: "customers",  label: "Mijozlar",    short: "Mijoz",   icon: <UserCircle    className="w-4 h-4" /> },
