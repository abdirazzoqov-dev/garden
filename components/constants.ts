...
export const INITIAL_PRODUCTS: Product[] = [
  // Fast-food
  { id: "prod_1", name: "Sirlangan Burger Klasik", category: "FOOD",    price: 32000, costPrice: 18000, stock: 45,  minStockAlert: 10, unit: "dona",    prepTime: 7,  isAvailable: true,  stallId: "stall_1", stallName: "Markaziy Fast-Food",     description: "Mol go'shtli burger, sous, sabzavot", barcode: "2001000000017", createdAt: "2026-01-01" },
  { id: "prod_2", name: "Shaurma Mol go'shtli",    category: "FOOD",    price: 38000, costPrice: 22000, stock: 28,  minStockAlert: 8,  unit: "dona",    prepTime: 8,  isAvailable: true,  stallId: "stall_1", stallName: "Markaziy Fast-Food",     description: "Mol go'shtli shaurma, chili sous",    barcode: "2001000000024", createdAt: "2026-01-01" },
  { id: "prod_3", name: "Coca-Cola 0.5L",          category: "DRINK",   price: 10000, costPrice: 6000,  stock: 9,   minStockAlert: 15, unit: "litr",    prepTime: 0,  isAvailable: true,  stallId: "stall_1", stallName: "Markaziy Fast-Food",     description: "Sovutilgan",                          barcode: "5449000000996", createdAt: "2026-01-01" },
  { id: "prod_4", name: "Kartoshka Fri (L)",       category: "SNACK",   price: 18000, costPrice: 8000,  stock: 60,  minStockAlert: 12, unit: "porsiya", prepTime: 5,  isAvailable: true,  stallId: "stall_1", stallName: "Markaziy Fast-Food",     description: "Tuzlangan, ketchup bilan",            barcode: "2001000000031", createdAt: "2026-01-01" },
  // Choyxona
  { id: "prod_5", name: "Ko'k Choy (Chinni)",      category: "TEA",     price: 8000,  costPrice: 2000,  stock: 200, minStockAlert: 30, unit: "piyola",  prepTime: 5,  isAvailable: true,  stallId: "stall_2", stallName: "Bog' Choyxonasi",        description: "Arzon, shirin, ko'k choy",            barcode: "2002000000017", createdAt: "2026-01-01" },
  { id: "prod_6", name: "Qora Choy + Shirinlik",   category: "TEA",     price: 12000, costPrice: 4000,  stock: 150, minStockAlert: 20, unit: "set",     prepTime: 5,  isAvailable: true,  stallId: "stall_2", stallName: "Bog' Choyxonasi",        description: "Qand-shakar, pechene bilan",          barcode: "2002000000024", createdAt: "2026-01-01" },
  { id: "prod_7", name: "Samsa (2 dona)",           category: "FOOD",    price: 16000, costPrice: 7000,  stock: 40,  minStockAlert: 10, unit: "porsiya", prepTime: 0,  isAvailable: true,  stallId: "stall_2", stallName: "Bog' Choyxonasi",        description: "Issiq, qo'y go'shtli samsa",          barcode: "2002000000031", createdAt: "2026-01-01" },
  { id: "prod_8", name: "Xalyopa (1 soat)",        category: "HOOKAH",  price: 80000, costPrice: 35000, stock: 15,  minStockAlert: 3,  unit: "dona",    prepTime: 10, isAvailable: true,  stallId: "stall_2", stallName: "Bog' Choyxonasi",        description: "Premium tutun, 5 xil ta'm",          barcode: "2002000000048", createdAt: "2026-01-01" },
  // Attraksion
  { id: "prod_9", name: "Katta Tsirk Chiptasi",    category: "TICKET",  price: 50000, costPrice: 0,     stock: 120, minStockAlert: 20, unit: "dona",    prepTime: 0,  isAvailable: true,  stallId: "stall_3", stallName: "Ko'ngilochar Attraksion", description: "Bolalar va kattalar uchun",           barcode: "2003000000017", createdAt: "2026-01-01" },
  { id: "prod_10",name: "Karusel Chiptasi",         category: "TICKET",  price: 20000, costPrice: 0,     stock: 200, minStockAlert: 30, unit: "dona",    prepTime: 0,  isAvailable: true,  stallId: "stall_3", stallName: "Ko'ngilochar Attraksion", description: "5 ta aylanish",                      barcode: "2003000000024", createdAt: "2026-01-01" },
  // Suvenirlar
  { id: "prod_11",name: "Esdalik Bog' Flagi",       category: "SOUVENIR",price: 25000, costPrice: 8000,  stock: 12,  minStockAlert: 5,  unit: "dona",    prepTime: 0,  isAvailable: true,  stallId: "stall_4", stallName: "Suvenirlar Markazi",     description: "24x36 sm, yuvishga chidamli",        barcode: "2004000000017", createdAt: "2026-01-01" },
  // Muzqaymoq
  { id: "prod_12",name: "Muzqaymoq Gilosli",        category: "DESSERT", price: 14000, costPrice: 6000,  stock: 3,   minStockAlert: 5,  unit: "dona",    prepTime: 0,  isAvailable: true,  stallId: "stall_5", stallName: "Muzqaymoq Dükoni",       description: "100ml, giloslisous",                 barcode: "2005000000017", createdAt: "2026-01-01" },
  { id: "prod_13",name: "Shakar-paxta (Katta)",     category: "DESSERT", price: 12000, costPrice: 3000,  stock: 22,  minStockAlert: 6,  unit: "dona",    prepTime: 2,  isAvailable: true,  stallId: "stall_5", stallName: "Muzqaymoq Dükoni",       description: "Katta vanna, turli rang",            barcode: "2005000000024", createdAt: "2026-01-01" },
  // VIP Kafe
  { id: "prod_14",name: "Kapuchino",                category: "DRINK",   price: 28000, costPrice: 10000, stock: 50,  minStockAlert: 8,  unit: "stakan",  prepTime: 4,  isAvailable: true,  stallId: "stall_6", stallName: "VIP Kafe",               description: "Italyan arabika, sut ko'pigi",       barcode: "2006000000017", createdAt: "2026-01-01" },
  { id: "prod_15",name: "Tiramisu",                 category: "DESSERT", price: 45000, costPrice: 18000, stock: 8,   minStockAlert: 3,  unit: "porsiya", prepTime: 0,  isAvailable: true,  stallId: "stall_6", stallName: "VIP Kafe",               description: "Klassik italyan desert",             barcode: "2006000000024", createdAt: "2026-01-01" },
];
